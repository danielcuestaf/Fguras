...
import figuras.logica.TrianguloRectangulo;
...
public class Figuras {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3. triangulorectangulo");
        System.out.println("4. Ciculo");
    ...
    public static void mostrar(Figura f, Punto origen , Punto fin){
        ...
        f.calcularArea();
        f.calcularPerimetro();
        System.out.println("area   es: " + f.getArea());
        System.out.println("perimetro es: " + f.getPerimetro());
